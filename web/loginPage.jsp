    ...
    <div>
      <header>
        <p class="Login_Total_Info">
         <a href="loginPage.jsp"><img src="img/outline_done_outline_black_24dp.png" title="Logo" height="50" width="55"></a>
          <strong><a href="loginPage.jsp">Every Score</a></strong>
        </p>
      </header>
      <form name="Login_Form" action="http://localhost:8080/api/v1/user" method ="post">
         ...
         <p class="Join_box">Every Score는 처음이야? <a href="joinPage.jsp">회원가입</a></p>
       </form>
    </div>
  </body>
</html>
